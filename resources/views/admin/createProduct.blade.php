...
@section('content')
    <div class="row d-flex justify-content-center pt-3">
        @if (session('message'))
        <div class="alert alert-success alert-dismissable fade show m-3 d-flex" role="alert" style="position: fixed; top: 0; right:0;width:auto;">
            {{session('message')}}
        ...
        <div class="col-8">
            ...
            <form action="{{route('create.product.action')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="stockInput" placeholder="Contoh : 20" name = "stock" min="1" max="99999"> 
                </div>
                <div class="mb-3">
                    <label for="minimumBuyInput" class="form-label">Minimum Buy</label>
                    <input type="number" class="form-control" id="minimumBuyInput" placeholder="Contoh : 1" name = "minimum_buy" min="1" max="99999">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="descriptionInput" rows="3" name ="description" placeholder="Contoh : Full natural"></textarea>
                </div>
