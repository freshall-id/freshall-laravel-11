    ...
    <div class="mt-5">
        ...
        <div class="mt-3 d-flex flex-column ">
            ...
            @foreach ($addresses as $address)
                        ...
                        <div class="card-body" style="background-color:#fff5d6">
                            ...
                            <div class="d-flex gap-4 justify-content-end mt-3" style="">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#updateModal{{ $address->id }}">
                                    Update Address
                                </button>
                            </div>
                        </div>
                ...
                <div class="modal fade" id="updateModal{{ $address->id }}" tabindex="-1"
                                    ...
                                    <div class="d-flex flex-column align-items-center">
                                        <div class="mb-3 d-flex">
                                            ...
                                            <input type="text" id="label" name="label" class="form-control"
                                                value="{{ $address->label }}" style="width:200px">
                                        </div>
                                        <div class="mb-3 d-flex">
                                            <label for="category" class="form-label mb-0 align-items-center d-flex"
                                                style="width:140px">Category</label>
                                            <select class="form-select" name="category" aria-label="Default select example"
                                                style="width:200px" value="{{ $address->category }}">
                                                <option value="{{ $address->category }}" selected>
                                                    {{ $address->category }}</option>
                                                @if ($address->category !== 'HOME')
                                                    <option value="HOME">HOME</option>
                                                @endif
                                                @if ($address->category !== 'KOST')
                                                    <option value="KOST">KOST</option>
                                                @endif
                                                @if ($address->category !== 'OFFICE')
                                                    <option value="OFFICE">OFFICE</option>
                                                @endif
                                                @if ($address->category !== 'APARTMENT')
                                            ...
                                            <input type="hidden" name="category" value="{{ $address->category }}">
                                        </div>
                                        <div class="mb-3 d-flex">
            ...
            <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('profileAddresses.insert') }}" method="POST">
                            @csrf
                            <div class="modal-body">
                                <div class="d-flex flex-column align-items-center">
                                    <div class="mb-3 d-flex">
                                    ...
                                    <div class="mb-3 d-flex">
                                        ...
                                        <select class="form-select" name="category" aria-label="Default select example"
                                            style="width:200px">
                                            <option value="{{ old('category') }}" disabled select>--select category--
                                            </option>
                                            <option value="HOME">HOME</option>
                                            <option value="KOST">KOST</option>
                                            <option value="OFFICE">OFFICE</option>
                                    ...
                                    <div class="mb-3 d-flex">
                                        <label for="receiver_name" class="form-label mb-0 align-items-center d-flex"
                                            style="width:140px">Receiver Name</label>
                                        <input type="text" id="receiver_name" name="receiver_name"
                                            class="form-control" value="{{ old('receiver_name') }}" style="width:200px">
                                    </div>
                                    <div class="mb-3 d-flex">
                                        <label for="receiver_phone" class="form-label mb-0 align-items-center d-flex"
                                            style="width:140px">Receiver Phone</label>
                                        <input type="text" id="receiver_phone" name="receiver_phone"
                                            class="form-control" value="{{ old('receiver_phone') }}"
                                            style="width:200px">
                                    </div>
                                    <div class="mb-3 d-flex">
